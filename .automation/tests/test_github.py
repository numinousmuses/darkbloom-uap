...
class CommentTests(unittest.TestCase):
    ...
    def test_requested_work_keeps_original_ci_classification(self):
        self.publish(state(trigger="ci"))
        self.publish(state(order=3, trigger="instructed"))
        self.assertEqual(metadata(self.comments[0]["body"])["trigger"], "ci")
